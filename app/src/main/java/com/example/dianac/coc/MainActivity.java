...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_coc) {
            fragmentClass = InstitucionFragment.class;
        } else if (id == R.id.nav_fed) {
            fragmentClass = FederacionesFragment.class;
        } else if (id == R.id.nav_depor) {
            fragmentClass = DeportistasFragment.class;
        } else if (id == R.id.nav_esc) {
            fragmentClass = EscenariosFragment.class;
        } else if (id == R.id.nav_patro) {
            fragmentClass = PatrocinadoresFragment.class;
        }
